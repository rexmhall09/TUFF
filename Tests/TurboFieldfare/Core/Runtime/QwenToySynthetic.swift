...
enum QwenToySynthetic {
    ...
    static func write() throws -> URL {
        ...
        // The v1 contract requires the index region to end on an alignment
        // boundary so the payload starts page-aligned.
        ...
        let manifestRoot: [String: Any] = [
            ...
            "modelID": "qwen-toy",
            "arch": archDict,
            // Mirrors the bit widths the specs above actually write: int4 for
            // the embedding, attention, and routed experts; int8 for the
